 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "cross_val_score(svm.SVC(kernel='linear',C=30,gamma='auto'),iris.data,iris.target,cv=3)\n",
    "cross_val_score\n"
   ]
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "{'mean_fit_time': array([0.00119619, 0.001088  , 0.00140305, 0.00095158, 0.00090322,\n",
       "        0.00088305]),\n",
       " 'std_fit_time': array([1.59920719e-04, 5.70919194e-04, 7.83877554e-04, 2.89935242e-04,\n",
       "        4.04667623e-05, 2.17669054e-04]),\n",
       " 'mean_score_time': array([0.00081153, 0.00060253, 0.00072727, 0.00053639, 0.00059724,\n",
       "        0.00049934]),\n",
       " 'std_score_time': array([9.69085625e-05, 1.69584331e-04, 7.55913390e-05, 3.55544059e-05,\n",
       "        3.27955134e-05, 2.10039055e-05]),\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0       0.001196      0.000160  ...        0.016330                1\n",
       "1       0.001088      0.000571  ...        0.016330                1\n",
       "2       0.001403      0.000784  ...        0.016330                1\n",
       "3       0.000952      0.000290  ...        0.038873                4\n",
       "4       0.000903      0.000040  ...        0.036515                5\n",
       "5       0.000883      0.000218  ...        0.042164                6\n",
       "\n",
       "[6 rows x 15 columns]"
      ]
     },
  ...
  },
  {
   ...
   "source": [
    ...
    "# pd.DataFrame(rs.cv_results_)[['param_c','param_kernal','mean_test_score']]\n",
    "from sklearn.model_selection import RandomizedSearchCV\n",
    "rs = RandomizedSearchCV(svm.SVC(gamma='auto'), {\n",
    "        'C': [1,10,20],\n",
    "        'kernel': ['rbf','linear']\n",
